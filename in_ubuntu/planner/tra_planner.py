# Code originally provided by Andres Rodrigo Zapata Rodriguez.
...
class LinearLocalPlanner:
    ...
    def update_position(self, pos):
        ...
        dist_zero = np.linalg.norm(current_curve.p0 - self.current_position) ** 2
        ...
        if u < 0:
            u = 0.0
        if u > 1:
            u = 0.0  # todo this makes more sense to me
            self.transition()
    ...
    def get_position_dev(self, pos):
        ...
        dist_value = np.linalg.norm(dist)
        self.k_dev = 0.8 * dist_value
        return dist.squeeze()
    ...
    def get_control_target(self, curr_pos):
        ...
        # print("controller target is ", controller_target)
